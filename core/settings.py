...
SECRET_KEY = 'django-insecure-opq7gp#o-k$ud!ylmys9oubi%8z^iel6gre^h*dfk34tg&=^^0'
...
DATABASES = {
  ...
  #  "default": {
   #     "ENGINE": "django.db.backends.mysql",
    #    "NAME": os.getenv("DB_NAME", "recibos_db"),
     #   "USER": os.getenv("DB_USER", "root"),
     #   "PASSWORD": os.getenv("DB_PASSWORD", "1234"),
     #   "HOST": os.getenv("DB_HOST", "db"),  # <- servicio del compose
